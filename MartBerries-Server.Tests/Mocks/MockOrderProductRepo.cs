...
public class MockOrderProductRepo
{
    public static Mock<IOrderedProductRepository> GetOrderProductRepository()
    {
        var orderedProducts = new List<OrderedProduct>
        {
            new OrderedProduct
            {
                ...
                Order = new Order(),
                OrderId = Guid.Parse("7559c608-107e-4b18-8d94-9dsb164d0ad"),
                Product = new Product(),
                ProductId = Guid.Parse("7559c608-107e-4b18-8d94-8d1fb164d1er")
            },
            new OrderedProduct
            {
                Amount = 5,
        ...
        mockRepo.Setup(r => r.AddAsync(It.IsAny<OrderedProduct>())).ReturnsAsync((OrderedProduct orderedProduct) =>
        {
            orderedProducts.Add(orderedProduct);
            return orderedProduct;
        });

        mockRepo.Setup(r => r.UpdateAsync(It.IsAny<OrderedProduct>())).ReturnsAsync((OrderedProduct orderedProduct) =>
        {
        ...
        mockRepo.Setup(r => r.DeleteAsync(It.IsAny<OrderedProduct>())).Returns((OrderedProduct orderedProduct) =>
        {
